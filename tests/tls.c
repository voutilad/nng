...
// have to regenerate it ever again. The CN is localhost, and self-signed.
//
...
// XXX: Can't figure out the magic incantation to get libtls to play nice with
// a secp224r1 curve, but it will work with a secp384r1, so that's what's used
// below.
#ifdef NNG_USING_LIBTLS
static const char cert[] =
        "-----BEGIN CERTIFICATE-----\n"
        "MIIB7TCCAXMCCQDRc7Y5B4cgLzAKBggqhkjOPQQDAjBfMQswCQYDVQQGEwJYWDEP\n"
        "MA0GA1UECAwGVXRvcGlhMREwDwYDVQQHDAhQYXJhZGlzZTEYMBYGA1UECgwPTk5H\n"
        "IFRlc3RzLCBJbmMuMRIwEAYDVQQDDAlsb2NhbGhvc3QwIBcNMjEwMjE2MTgxODU4\n"
        "WhgPMjEyMTAxMjMxODE4NThaMF8xCzAJBgNVBAYTAlhYMQ8wDQYDVQQIDAZVdG9w\n"
        "aWExETAPBgNVBAcMCFBhcmFkaXNlMRgwFgYDVQQKDA9OTkcgVGVzdHMsIEluYy4x\n"
        "EjAQBgNVBAMMCWxvY2FsaG9zdDB2MBAGByqGSM49AgEGBSuBBAAiA2IABB+zKuoJ\n"
        "o1fhUOBkRmEsyrgFqkedoI6vs9upZ0yMrojmdigyfRSjnqtkqNtoHgPsRA4kzDk+\n"
        "VBhxbfB6u9befkqqBxuylCa94LkihrrzvyVDUgcx8WtLsCbpalrOhMiN+zAKBggq\n"
        "hkjOPQQDAgNoADBlAjEAmOsGw5xECbzfln4dWlRh+zsTCqDLZ7zWLpW0E++5wolv\n"
        "XtYoAZpgGCtxDKO5gfdDAjARzAtsKQUf30GHywiWVBQJSsAbXeGCBSW/QCJQIvGY\n"
        "RBS8H/G2yUHtxeTHi+N5a9o=\n"
        "-----END CERTIFICATE-----\n";
...
static const char key[] =
        ...
        "MIGkAgEBBDBCSaHjTRCxNEp8DQxS6orsxaDTU4iXstVA1NWisMoI2rJkVMA8qvH2\n"
        "svjv6UDJuBigBwYFK4EEACKhZANiAAQfsyrqCaNX4VDgZEZhLMq4BapHnaCOr7Pb\n"
        "qWdMjK6I5nYoMn0Uo56rZKjbaB4D7EQOJMw5PlQYcW3wervW3n5KqgcbspQmveC5\n"
        "Ioa6878lQ1IHMfFrS7Am6WpazoTIjfs=\n"
        "-----END EC PRIVATE KEY-----\n";
#else
static const char cert[] =
        "-----BEGIN CERTIFICATE-----\n"
